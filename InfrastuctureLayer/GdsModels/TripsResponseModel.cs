...
namespace InfrastuctureLayer.GdsModels
{
    public class TripsResponseModel
    {
        ...
        public class Trip
        {
            [XmlElement(ElementName = "Supplier")] public string Supplier { get; set; }

            [XmlElement(ElementName = "Fligth")] public string Fligth { get; set; }

            [XmlElement(ElementName = "variants")] public Variants Variants { get; set; }
        }
        ...
        {
            [XmlElement(ElementName = "variant")] public List<Variant> Variant { get; set; }
        }

        [XmlRoot(ElementName = "Trips")]
        public class Trips
        {
            [XmlElement(ElementName = "Trip")] public List<Trip> Trip { get; set; }
        }
    }
}